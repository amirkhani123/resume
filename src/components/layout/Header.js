...
function Header() {
  return (
    <header className="w-full flex items-center justify-between my-2 p-2 sticky top-1 left-0 box-blur rounded-lg max-md:p-px z-10 max-md:top-0 ">
      <Link href="/" className="font-marhey text-lg max-md:text-base">
        AMIR KHANI
      </Link>
      <div className="flex gap-3 items-center max-md:gap-2 font-vazir">
        <Link href="/#about-me" className="under-line" >About Me</Link>
        <Link
          href="/contact-me"
